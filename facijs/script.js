document.addEventListener('DOMContentLoaded', function() {
    const departamentos = {
        ...
        'Canindeyú': ['Corpus Christi', 'Curuguaty', 'Gral. Francisco Caballero Álvarez', 'Itanará', 'Katueté', 'La Paloma', 'Nueva Esperanza', 'Salto del Guairá', 'Villa Ygatimí', 'Yasy Cañy', 'Yby Pytá', 'Ypejhú', 'Ybyrarobana'],
        ...
        'Concepción': ['Asotey','Belén', 'Concepción', 'Horqueta', 'Loreto', 'San Carlos del Apa', 'San Lázaro', 'Yby Yaú', 'Paso Barreto'],
        ...
        'San Pedro': ['Antequera', 'Capiibary', 'Choré', 'Gral. Isidro Resquín', 'Gral. Elizardo Aquino', 'Guayaibí', 'Itacurubí del Rosario', 'Liberación', 'Lima', 'Nueva Germania', 'San Estanislao', 'San Vicente Pancholo', 'San Pedro de Ycuamandiyú', 'Santa Rosa del Aguaray', 'Tacuatí', 'Unión', 'Villa del Rosario', 'Yataity del Norte'],
        'Paraguarí': ['Acahay', 'Caapucú', 'Carapeguá', 'Escobar', 'Gral. Bernardino Caballero', 'La Colmena', 'Mbuyapey', 'Paraguarí', 'Pirayú', 'Quiindy', 'Quyquyhó', 'San Roque González', 'Sapucai', 'Tebicuarymí', 'Yaguarón', 'Ybycuí'],
        'Ñeembucú': ['Alberdi', 'Cerrito', 'Desmochados', 'Gral. José Eduvigis Díaz', 'Guazú Cuá', 'Humaitá', 'Isla Umbú', 'Laureles', 'Mayor José Dejesús Martínez', 'Pilar', 'San Juan Bautista del Ñeembucú', 'Tacuaras', 'Villa Franca', 'Villa Oliva', 'Villa Victoria', 'Paso de Patria', 'Yabebyry']
